...
namespace iMinify
{
    class Creator
    {
        ...
        private string[] namespaces = {
            ...
            "System.Text" , "System.Threading.Tasks" , "System.Media.SoundPlayer",
            "System.Net.Sockets","System.Net.WebSockets"};

        private string[] variables = { "int", "float", "double", "bool" };

        private string[] names = { "x", "y", "z", "level", "name", "test", "counter", "i", "j", "k" };

        private string[] comments =
        {
            "This is just a multiline", "Test",
            "Hello","World","Multi","Line","Here",
            "Hello how are you today", "Are you fine ?",
        };
        ...
        public string CreateRandomFile(int approximateSize, string extension)
        {
            ...
            int commentsNo = random.Next(0, approximateSize * 40);
            int variableNo = random.Next(0, approximateSize * 40);
            ...
            using(StreamWriter writer = new StreamWriter(filename + extension))
            {
                ...
                for (int i = 0; i < approximateSize * 40; i++)
                {
                ...
                sb.Append("int main" + Environment.NewLine);
                sb.Append("{");
                sb.Append("}");
